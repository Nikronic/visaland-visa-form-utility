...
CANADA_5257E_DROP_COLUMNS = [
    ...
    "P2.MS.SecA.DateLastValidated.DateCalc",
    "P2.MS.SecA.DateLastValidated.Year",
    "P2.MS.SecA.DateLastValidated.Month",
    "P2.MS.SecA.DateLastValidated.Day",
    "P2.MS.SecA.PsprtSecHeader.@ns0:dataNode",
    "P2.MS.SecA.Psprt.IssueYYYY",
    "P2.MS.SecA.Psprt.IssueMM",
    "P2.MS.SecA.Psprt.IssueDD",
    "P2.MS.SecA.Psprt.expiryYYYY",
    "P2.MS.SecA.Psprt.expiryMM",
    "P2.MS.SecA.Psprt.expiryDD",
    "P2.MS.SecA.Langs.languagesHeader.@ns0:dataNode",
    "P2.natID.SecHeader.@ns0:dataNode",
    "P2.natID.natIDdocs.IssueDate.IssueDate",
    "P2.natID.natIDdocs.ExpiryDate",
    "P2.USCard.SecHeader.@ns0:dataNode",
    "P2.USCard.SecHeader.@ns0:dataNode",
    "P2.USCard.usCarddocs.ExpiryDate",
    "P2.USCard.usCarddocs.DocNum.DocNum",
    "P2.CI.cntct.cntctInfoSecHeader.@ns0:dataNode",
    "P2.CI.cntct.AddrRow1.POBox.POBox",
    "P2.CI.cntct.AddrRow1.Apt.AptUnit",
    "P2.CI.cntct.AddrRow1.StreetNum.StreetNum",
    "P2.CI.cntct.AddrRow1.Streetname.Streetname",
    "P2.CI.cntct.AddrRow2.ProvinceState.ProvinceState",
    "P2.CI.cntct.AddrRow2.PostalCode.PostalCode",
    "P2.CI.cntct.AddrRow2.District",
    "P2.CI.cntct.ResiialAddrRow1.AptUnit.AptUnit",
    "P2.CI.cntct.ResiialAddrRow1.StreetNum.StreetNum",
    "P2.CI.cntct.ResiialAddrRow1.StreetName.Streetname",
    "P2.CI.cntct.ResiialAddrRow2.District",
    "P2.CI.cntct.ResiialAddrRow2.ProvinceState.ProvinceState",
    "P2.CI.cntct.PhnNums.Phn.NumCountry",
    "P2.CI.cntct.ResiialAddrRow2.PostalCode.PostalCode",
    "P2.CI.cntct.PhnNums.Phn.ActualNum",
    "P2.CI.cntct.PhnNums.Phn.NANum.AreaCode",
    "P2.CI.cntct.PhnNums.Phn.NANum.FirstThree",
    "P2.CI.cntct.PhnNums.Phn.NANum.LastFive",
    "P2.CI.cntct.PhnNums.Phn.IntlNum.IntlNum",
    "P2.CI.cntct.PhnNums.AltPhn.NumCountry",
    "P2.CI.cntct.PhnNums.AltPhn.ActualNum",
    "P2.CI.cntct.PhnNums.AltPhn.NANum.AreaCode",
    "P2.CI.cntct.PhnNums.AltPhn.NANum.FirstThree",
    "P2.CI.cntct.PhnNums.AltPhn.NANum.LastFive",
    "P2.CI.cntct.PhnNums.AltPhn.IntlNum.IntlNum",
    "P2.CI.cntct.FaxEmail.Phn.CanadaUS",
    "P2.CI.cntct.FaxEmail.Phn.Other",
    "P2.CI.cntct.FaxEmail.Phn.NumExt",
    "P2.MS.SecA.Psprt.IssueDate.IssueDate",
    "P2.CI.cntct.FaxEmail.Phn.NumCountry",
    "P2.CI.cntct.FaxEmail.Phn.ActualNum",
    "P2.CI.cntct.FaxEmail.Phn.NANum.AreaCode",
    "P2.CI.cntct.FaxEmail.Phn.NANum.FirstThree",
    "P2.CI.cntct.FaxEmail.Phn.NANum.LastFive",
    "P2.CI.cntct.FaxEmail.Phn.IntlNum.IntlNum",
    "P2.CI.cntct.FaxEmail.Email",
    "P3.SecHeader_DOV.@ns0:dataNode",
    "P3.DOV.cntcts_Row1.AddrInCanada.AddrInCanada",
    ...
    "P3.BGI2.Details.refusedDetails",
    "P3.PWrapper.BGI3.details",
    "P3.PWrapper.Military.militaryServiceDetails",
    "P1.PD.AliasName.AliasGivenName",
    "P1.PD.AliasName.AliasFamilyName",
    "P2.MS.SecA.PMFamilyName",
    "P2.MS.SecA.GivenName.PMGivenName",
    "P3.DOV.cntcts_Row1.Name.Name",
    "P3.cntcts_Row2.Name.Name",
    "P1.PD.PrevCOR.Row3.Other",
    "P3.cntcts_Row2.AddrInCanada.AddrInCanada",
    "P3.Edu.Edu_Row1.FromMonth",
    "P3.Edu.Edu_Row1.ToMonth",
    "P3.Edu.Edu_Row1.School",
    "P3.Edu.Edu_Row1.CityTown",
    "P3.Edu.Edu_Row1.ProvState",
    "P3.Occ.OccRow1.FromMonth",
    "P3.Occ.OccRow1.ToMonth",
    "P3.Occ.OccRow1.CityTown.CityTown",
    "P3.Occ.OccRow1.ProvState",
    "P3.Occ.OccRow2.FromMonth",
    "P3.Occ.OccRow2.ToMonth",
    "P3.Occ.OccRow2.CityTown.CityTown",
    "P3.Occ.OccRow2.ProvState",
    "P3.Occ.OccRow3.FromMonth",
    "P3.Occ.OccRow3.ToMonth",
    "P3.Occ.OccRow3.CityTown.CityTown",
    "P3.Occ.OccRow3.ProvState",
    "P1.PD.Name.FamilyName",
    "P1.PD.Name.GivenName",
    "P1.PD.PrevCOR.Row2.Other",
    "P1.MS.SecA.FamilyName",
    "P1.MS.SecA.GivenName",
    "P2.MS.SecA.PrevSpouseDOB.DOBMonth",
    "P2.MS.SecA.PrevSpouseDOB.DOBDay",
    "P2.MS.SecA.Psprt.PsprtNum.PsprtNum",
    "P2.natID.natIDdocs.DocNum.DocNum",
    "P2.MS.SecA.Langs.languages.lov",
    "P3.Occ.OccRow1.Employer",
    "P3.Occ.OccRow2.Employer",
    "P3.Occ.OccRow3.Employer",
    "P1.Age",
    "P2.MS.SecA.Psprt.TaiwanPIN",
    "P2.MS.SecA.Psprt.IsraelPsprtIndicator",
]
...
FINANCIAL_RATIOS = {
    # house related
    "rent2deposit": 100.0 / 3.0,  # rule of thumb provided online
    "deposit2rent": 3.0 / 100.0,
    "deposit2worth": 5.0,  # rule of thumb provided online
    "worth2deposit": 1.0 / 5.0,
    # company related
    "tax2income": 100.0
    / 15.0,  # 10% for small, 20% for larger, we use average 15% tax rate
    "income2tax": 15.0 / 100.0,
    # a company worth 15x of its income for minimum: C[T/E]O suggestion
    "income2worth": 15.0,
    "worth2income": 1.0 / 15.0,
}
...
class CanadaGeneralConstants:
    ...
    """
    MAXIMUM_EXPIRY_PASSPORT: float = 10.0
    ...
    """Minimum time required for `passport_expiry_date_remaining`
    """
    MAXIMUM_EDUCATION_PERIOD: float = 10.0
    """Maximum time required for `passport_expiry_date_remaining`
    """
...
FEATURE_CATEGORY_TO_FEATURE_NAME_MAP = {
    FeatureCategories.PURPOSE: [
        "P1.PD.CurrCOR.Row2.Country",
        "P1.PD.CurrCOR.Row2.Status",
        "P1.PD.PrevCOR.Row2.Country",
        "P1.PD.PrevCOR.Row3.Country",
        "P1.PD.SameAsCORIndicator",
        "P1.PD.CWA.Row2.Country",
        "P1.PD.CWA.Row2.Status",
    ...
    FeatureCategories.EMOTIONAL: [
        ...
        "P1.MS.SecA.DateOfMarr.Period",
        "P2.MS.SecA.Period",
        "p1.SecA.App.ChdMStatus",
        ...
        "p1.SecC.Chd.X.ChdRel.ChdCount",
        "p1.SecX.LongDistAddr",
        # doubted
        "P1.PD.DOBYear.Period",
        "p1.SecC.Chd.X.ChdCOB.ForeignerCount",
        "p1.SecB.ChdMoFaSps.X.ChdCOB.ForeignerCount",
        "p1.SecX.ForeignAddr",
        # shared
