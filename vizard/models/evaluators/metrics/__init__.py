...
:mod:`vizard.models.estimators.networks <vizard.models.estimators.networks>`
or other appropriate submodules then import them here and just make a call to them.
For instance assume we have VGG models in `vizard.models.estimators.networks.vgg.py`::

    from vizard.models.estimators.networks.vgg import vgg16
