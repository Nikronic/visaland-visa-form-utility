...
The final goal of all modules (interfaces) is to even further extract, simplify, and transform these "explanatory" values to
be understandable by non-technical users (an actual pleb and/or pepega). Hence, these modules might intentionally oversimplify 
things that actually might be theoretically unsound! (See issue #56)
